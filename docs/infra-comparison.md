...
| サービス | 月額 | RAM / CPU / SSD | 東京リージョン | 円払い | 備考 |
|----------|------|-----------------|--------------|--------|------|
| **Hetzner CAX11** | €3.79 | 4GB / 2vCPU / 40GB | ✗ | ✗ | ◎ コスパ最良。トレードボット用途なら遅延問題なし |
| **Contabo VPS S** | €3.60〜 | 8GB / 4vCPU / 75GB NVMe | ✓ 東京あり | ✗ | ◎ 東京リージョン＋高スペック。無制限データ転送 |
| **ConoHa VPS** | ¥296〜687 | 512MB〜1GB / 1コア | ✓ 東京あり | ✓ | ○ 国内最安級。キャンペーン価格。時間課金対応 |
| **KAGOYA VPS** | ¥550上限 | 2GB〜 / 2コア〜 | ✓ 国内複数 | ✓ | ○ 2025年リニューアル。NVMe SSD。1日単位利用可 |
| **さくらのVPS** | ¥590〜643 | 512MB / 1コア / 25GB | ✓ 東京あり | ✓ | △ 14日無料試用。スペック比でやや割高 |
| **Vultr Tokyo** | $6 | 1GB / 1コア / 25GB | ✓ 東京あり | ✗ | △ スペック低め。東京接続重視なら選択肢 |
| **Linode (Akamai)** | $5 | 1GB / 1コア / 25GB | ✓ 東京あり | ✗ | △ 新規$200クレジットあり |
| **DigitalOcean** | $4〜5 | 512MB〜1GB / 1コア | ✗ 日本なし | ✗ | △ 最寄りはシンガポール |

### 推奨

| 優先事項 | 推奨 | 理由 |
|----------|------|------|
| **コスパ最優先** | Hetzner CAX11 | 4GB RAM が €3.79。群を抜いたコスパ |
| **東京リージョン＋コスパ** | Contabo 東京 | 8GB/4コア で €3.60〜。東京接続かつ高スペック |
| **円払い・国内サポート重視** | ConoHa VPS | キャンペーン時 ¥296〜。日本語サポート充実 |
